...
if python_version.startswith('2'):
    ...
    if build_flask_dot_env_file:
        ...
        print("")
        print("")
        print("SET SQLALCHEMY SECRET KEY")
        flask_secret_key = input("secret key for SQLALCHEMY: can be anything you would like:  ")
        while flask_secret_key == '':
            print("please enter a secret key. It really can be anything. Just type something, anything... we believe in you")
            flask_secret_key = input("secret key for SQLALCHEMY: can be anything you would like:  ")
